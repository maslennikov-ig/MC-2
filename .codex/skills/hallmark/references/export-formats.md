...
If the page introduces _additional_ tokens, name them by role and add to `tokens.css`. Don't make up token names downstream that aren't in `tokens.css` — the source of truth is the source of truth.
...
:root {
  ...
  --foreground: 15% 0.01 75; /* ink */

  --card: 94% 0.02 80; /* paper-2 */
  --card-foreground: 15% 0.01 75; /* ink */

  --popover: 94% 0.02 80; /* paper-2 */
  --popover-foreground: 15% 0.01 75; /* ink */
