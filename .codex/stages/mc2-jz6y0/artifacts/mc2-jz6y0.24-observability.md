...
verification:
  ...
  - Unified migrations/reconciliation applied gate: 21/21 on PostgreSQL 16, including both exact history rows, transactional totals atomicity, partial recovery, full reverse rollback/reapply, deferred direct terminal inserts with exact item/mode/coverage-status enforcement, runtime epochs, invalid-index recovery, and out-of-order latest coverage
