...
docs_review_notes: Exact D5 bytes are owner-approved and independently P0-P3-zero; the unchanged design-file header records its pre-approval review snapshot while this artifact records normative acceptance.
graph_reviewed: no-change-needed
graph_review_notes: Acceptance changes no design bytes; refresh is deferred to the immediately following D5 plan and implementation integration boundary.
verification:
  ...
  - owner replied Да подтверждаю делай to the exact-SHA approval request on 2026-07-14
changed_files:
  - .prettierignore
  - docs/superpowers/specs/2026-07-14-q12-retained-barrier-capability-provenance-addendum-design.md
  - .codex/stages/mc2-jz6y0/artifacts/mc2-jz6y0.13.17-q12-d5-provenance-decision.md
  ...
  - .codex/handoff.md
explicit_defers:
  - implementation planning producer and validator TDD W integration and M H Root execution remain downstream work under the now-approved contract
...
The owner explicitly approved the exact candidate path and SHA-256 above on
2026-07-14 by replying `Да, подтверждаю, делай` to the exact-SHA request. The
unchanged bytes are now normative, decision `.13.17` may close, and local
planning plus Root-producer/W-validator TDD may proceed through M, H, Root,
joined verification, and independent review. This decision never authorizes
remote or live mutation; those gates remain separate.
