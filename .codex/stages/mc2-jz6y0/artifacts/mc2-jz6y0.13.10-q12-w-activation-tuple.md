...
- field 4 `activation_barrier_sha256` → `bdb9d935e3c09fb01503ba9d016f36a9cf94db5539dfcdc73c1692eb442925ce`
  (whole-file sha; both #13 and #14 land here). Prior: `3673ee49…` (pre-defrost) / `cb4c4f4a…` (#13 interim).
- field 5 `activation_sql_projection_sha256` → `4aec7a61b70967c8b1b662f076feb01ab3db1f2ced398138b0c188c280da215b`
  (8872 bytes; +33B from #13). Prior: `a42d6d39…` (8839 bytes).
- field 6 `activation_normal_slice_sha256` → `0c8eed33fe9b9ef2ed141e625454684f67ae21365c048d3cf1ed4a75ae422735`
