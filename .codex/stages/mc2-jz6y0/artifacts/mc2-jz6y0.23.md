...
verification:
  ...
  - Shared document-evidence contracts passed 14/14; focused affected E3/Stage 4 units passed 138/138; E3 static plus durable-side static migrations passed 13/13.
  - Disposable PostgreSQL 15.18 passed the original E3 applied matrix 26/26 and the forward/rollback/idempotent durable-side matrix 3/3.
...
- Affected E3/Stage 4 unit matrix across side handle, detector, decision service, repository, preflight, boundary/live wiring, router and LLM client -> 138/138.
...
- Static migrations -> 13/13. On disposable PostgreSQL 15.18, original E3 applied tests -> 26/26 and durable-side forward/rollback/idempotency tests -> 3/3. Image `postgres:15.18-alpine`, digest `sha256:3d0f7584ed7d04e27fa050d6683a74746608faf21f202be78460d679cc56461f`.
