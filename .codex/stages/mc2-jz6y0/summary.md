...
Current accepted integration evidence: `679ea751` (accepted core, workflow/CAS, audited reindex, failed-coverage evidence/SQL, multi-ledger adapters, isolated runtime, and crash-residue/inode matrix)
Integration branch: `codex/self-hosted-qdrant-platform`
Implementation scope: Q1-Q11 plus Q12 guarded migration/operator/rollback/snapshot, source-recovery core, reviewed workflow/CAS, audited reindex, failed-coverage evidence/SQL, concrete multi-ledger adapters, isolated operator runtime, and the crash-residue/inode matrix are locally accepted. Synthetic 42-target acceptance, backup-gate correction, closeout, and live execution remain open. Fresh integration passed crash/recovery/reindex 453/453 and runtime/operator/Compose 34/34 plus package type-check, shell, CI, artifact, and process gates; earlier Stage 4/5/6 and PostgreSQL gates remain accepted.
