...
Current accepted integration evidence: `6f1339ee` (accepted core, workflow/CAS, audited reindex, failed-coverage evidence/SQL, concrete multi-ledger adapters, and isolated operator runtime)
Integration branch: `codex/self-hosted-qdrant-platform`
Implementation scope: Q1-Q11 plus Q12 guarded migration/operator/rollback/snapshot, source-recovery core, reviewed workflow/CAS, audited reindex, failed-coverage evidence/SQL, concrete multi-ledger adapters, and isolated operator runtime are locally accepted. Crash-residue correction rereview, synthetic 42-target acceptance, closeout, and live execution remain open. Fresh integration passed adapter recovery/reindex 146/146 and runtime/operator/Compose 34/34 plus package type-check, shell, CI, artifact, and process gates; earlier Stage 4/5/6 and PostgreSQL gates remain accepted.
