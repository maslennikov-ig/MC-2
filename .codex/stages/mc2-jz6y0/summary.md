...
Current accepted integration evidence: `2feeb516` (accepted core, workflow/CAS, audited reindex, failed-coverage evidence/SQL, and concrete multi-ledger reindex adapters)
Integration branch: `codex/self-hosted-qdrant-platform`
Implementation scope: Q1-Q11 plus Q12 guarded migration/operator/rollback/snapshot, source-recovery core, reviewed workflow/CAS, reviewed audited reindex, reviewed failed-coverage evidence/SQL, and concrete multi-ledger reindex adapters are locally accepted. Runtime/operator wiring, synthetic 42-target acceptance, closeout, and live execution remain open. Fresh adapter integration passed recovery/reindex 146/146, package type-check, artifact validation, and process verification; earlier Stage 4/5/6 128/128 and PostgreSQL 15.18/16.14 gates remain accepted.
