...
Current accepted integration evidence: `2f890558` (accepted core, workflow/CAS, audited reindex, and failed-coverage evidence/SQL)
Integration branch: `codex/self-hosted-qdrant-platform`
Implementation scope: Q1-Q11 plus Q12 guarded migration/operator/rollback/snapshot, source-recovery core, reviewed workflow/CAS, reviewed audited reindex, and reviewed failed-coverage evidence/SQL are locally accepted. Runtime/operator wiring, synthetic 42-target acceptance, closeout, and live execution remain open. Integration passed Stage 4/5/6 128/128, PostgreSQL 15.18 51/51, approved PostgreSQL 16.14 19/19, package type-check, and process verification.
