...
1. @neuledge/context MCP first; mcp__context7__resolve-library-id only as L2 fallback to resolve library name to ID
2. mcp__context7__query-docs only as L2 fallback to query docs by resolved ID + topic
```
...
# Step 1: @neuledge/context query first; if L1 misses/stale, mcp__context7__resolve-library-id
# Step 2: mcp__context7__query-docs only as L2 fallback
```
