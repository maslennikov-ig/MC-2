...
**Kit location**: `/home/me/code/claude-code-orchestrator-kit`
...
```bash
KIT="/home/me/code/claude-code-orchestrator-kit"
...
- `$KIT/.claude/commands/work.md` → `$DEST/work.md`
- `$KIT/.claude/commands/status.md` → `$DEST/status.md`
- `$KIT/.claude/commands/upgrade.md` → `$DEST/upgrade.md`
- `$KIT/.claude/commands/onboard.md` → `$DEST/onboard.md`
...
- `$KIT/.claude/templates/CLAUDE.md` → `$PROJECT_PATH/CLAUDE.md`
- `$KIT/.claude/templates/AGENTS.md` → `$PROJECT_PATH/AGENTS.md`
- `$KIT/.claude/templates/GEMINI.md` → `$PROJECT_PATH/GEMINI.md`
