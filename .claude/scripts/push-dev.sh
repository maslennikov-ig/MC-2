#!/usr/bin/env bash
#
# Dev Delivery Script - Merge current feature branch into develop and push develop
#
...
Promote the current feature branch into develop and push develop.
...
main() {
    ...
    case "$current_branch" in
        ...
        develop|feature/*)
            ;;
        *)
            log_error "This command only supports 'develop' or 'feature/*' branches"
