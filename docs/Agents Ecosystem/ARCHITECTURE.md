...
For LLM-based operations in the course generation platform, we use a unified 5-layer regeneration system to handle failures:
...
- Layer 4 (Model escalation 20B→120B): +10-15%
- Layer 5 (Quality fallback - Kimi K2): +5-8%

**Total**: ~99.5% success rate with all layers enabled

### Configuration

**Stage 4 (Analysis)**: All phases use all 5 layers
