...
const MODELS = [
  { slug: 'kimi-linear-48b', apiName: 'moonshotai/kimi-linear-48b-a3b-instruct', name: 'Kimi Linear 48B' },
  { slug: 'qwen3-235b-a22b-2507', apiName: 'qwen/qwen3-235b-a22b-2507', name: 'Qwen3 235B A22B 2507' },
  { slug: 'qwen-plus-2025-07-28', apiName: 'qwen/qwen-plus-2025-07-28', name: 'Qwen Plus 2025-07-28' }
];
...
async function main() {
  console.log('╔═══════════════════════════════════════════════════════════════╗');
  console.log('║                                                               ║');
  console.log('║         LLM Test Run 6 - 3 NEW MODELS                         ║');
  console.log('║                                                               ║');
  console.log('╚═══════════════════════════════════════════════════════════════╝\n');
