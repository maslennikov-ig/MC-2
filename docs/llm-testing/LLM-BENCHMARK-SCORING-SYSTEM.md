...
| ------------------------- | ------------ | -------- | ------------------------------------------- |
| **Глубина контента**      | 30           | 30%      | Насколько глубоко и детально раскрыта тема  |
| **Практическая ценность** | 25           | 25%      | Примеры, кейсы, применимость на практике    |
| **Структура и логика**    | 20           | 20%      | Последовательность, scaffolding, связность  |
| **Языковое качество**     | 15           | 15%      | Грамматика, терминология, стиль, читаемость |
| **Соответствие заданию**  | 10           | 10%      | Следование инструкциям и формату            |
...
### 1. Глубина контента (0-30 баллов)

**Оценивается:**

- Полнота раскрытия темы
- Уровень детализации
- Многогранность рассмотрения (разные аспекты)
- Примеры и иллюстрации

**Шкала:**

- **25-30**: Экспертный уровень, глубже чем ожидалось
- **20-24**: Хорошая глубина, все ключевые аспекты
- **15-19**: Базовое раскрытие, но поверхностно
- **10-14**: Слабая глубина, много пропусков
- **0-9**: Очень поверхностно, почти нет содержания
...
- **22-25**: Можно сразу применить, отличные кейсы
- **18-21**: Хорошие примеры, понятно как использовать
- **12-17**: Есть примеры, но абстрактные
- **6-11**: Мало практики, в основном теория
- **0-5**: Чистая теория без примеров

### 3. Структура и логика (0-20 баллов)

**Оценивается:**

- Логическая последовательность
- Наличие введения, основной части, выводов
- Связи между разделами
- Scaffolding (от простого к сложному)

**Шкала:**

- **18-20**: Идеальная структура, легко читается
- **14-17**: Хорошая структура, мелкие недочёты
- **10-13**: Структура есть, но путанная
- **5-9**: Слабая структура, хаотичное изложение
- **0-4**: Нет структуры, поток сознания

### 4. Языковое качество (0-15 баллов)

**Оценивается:**

- Грамматическая корректность
- Профессиональная терминология
- Стиль и тон (бизнес vs разговорный)
- Читаемость и ясность

**Шкала:**

- **14-15**: Безупречно, уровень редактора
- **11-13**: Очень хорошо, минимум правок
- **7-10**: Хорошо, но есть шероховатости
- **4-6**: Много ошибок, неуклюжие фразы
- **0-3**: Плохо читается, серьёзные ошибки

### 5. Соответствие заданию (0-10 баллов)
...
- Правильная длина/объём

**Шкала:**

- **9-10**: Всё по заданию, идеально
- **7-8**: Почти всё, мелкие отклонения
- **5-6**: Основное выполнено, часть пропущена
- **2-4**: Много не соответствует заданию
- **0-1**: Не по теме, проигнорировано задание
