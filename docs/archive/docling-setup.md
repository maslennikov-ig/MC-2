  ...
  "mcpServers": {
    "docling-mcp": {
      ...
      "args": [
        ...
        "--init",
        "-v",
        "/home/me/code/megacampus2/packages/course-gen-platform/uploads:/app/uploads:ro",
        "--network",
        "megacampus-network",
        "-e",
...
const document = await client.convertToDoclingDocument('/app/uploads/org123/course456/file789.pdf');

// Convert to Markdown
const markdown = await client.convertToMarkdown('/app/uploads/org123/course456/file789.pdf');
