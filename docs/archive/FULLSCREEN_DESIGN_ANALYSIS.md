      ...
      <main className="relative z-10 min-h-screen">
        ...
        <div className="w-full px-4 sm:px-6 md:px-8 lg:px-12 py-4 sm:py-6 md:py-8 pb-12 sm:pb-16 md:pb-20">
          ...
          >
            ...
            <h1
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white mb-2 sm:mb-3 md:mb-4 lg:mb-6"
              style={{
                textShadow:
            ...
            <p
              className="text-lg md:text-xl lg:text-2xl text-white max-w-2xl mx-auto"
              style={{
