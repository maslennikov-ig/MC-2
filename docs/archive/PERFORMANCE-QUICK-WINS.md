...
export const protectedProcedure = t.procedure.use(authMiddleware).use(performanceMonitoring);
```
...
export class RedisCache {
  ...
  private logCacheStats() {
    const namespaces = new Set([...this.hitCount.keys(), ...this.missCount.keys()]);
