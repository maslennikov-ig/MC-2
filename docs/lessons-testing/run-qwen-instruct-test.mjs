/**
 * Run tests for Qwen3 235B Instruct model
 * API: qwen/qwen3-235b-a22b-2507
 */
...
async function main() {
  ...
  console.log('');
  console.log('     QWEN3 235B INSTRUCT TEST (qwen/qwen3-235b-a22b-2507)');
  console.log('');
  console.log('='.repeat(70));
  console.log('');
