# Q12 Durable Recovery Projections Addendum Design

| Field                      | Value                                                                        |
| -------------------------- | ---------------------------------------------------------------------------- |
| Date                       | 2026-07-14                                                                   |
| Beads                      | `mc2-jz6y0.13.16`, `mc2-jz6y0.13.10`, `mc2-jz6y0.13.12`, `mc2-jz6y0.13.13`   |
| Status                     | owner approved in the current task on 2026-07-14; normative rereview pending |
...
| Approved D4 v4 evidence    | `e6ac9c5eb4b8f5a5c0b27626dfe7675d5e98c25bf219ddb0ae65df7087e9e6d9`           |

## Purpose and precedence

This is a narrow normative addendum to the approved base design and recoverable-lifecycle addendum. It freezes the previously underspecified host-command capability, resume, immutable quiesce, database terminal proof, receipt CAS, and recovery projections shared by W, H, and Root. The exact precedence delta below is exhaustive; every unrelated approved invariant remains in force.

External S3 and Qdrant Cloud remain out of scope. Nothing in this document authorizes GHCR publication, server or service changes, Supabase or Qdrant mutation, deployment, live reindex, alias cutover, credential rotation, staging, or production activity. Those effects remain inside the separate current-task Q12 remote gate.

## Selected decisions

This normative addendum selects both independently reviewed Option A recommendations:
...
The owner explicitly approved the exact D4 v4 clarification in the current task on 2026-07-14 by replying `Подтверждаю` directly to the complete approval sentence. D4 v4 SHA-256 `e6ac9c5eb4b8f5a5c0b27626dfe7675d5e98c25bf219ddb0ae65df7087e9e6d9` received independent correctness and documentation PASS, both P0=P1=P2=P3=0. This approval authorizes normative incorporation and safe local implementation, tests, review, commit, and push only.
...
This addendum adds that one kind to the otherwise closed accepted-object enum.
...
This normative addendum and its implementation plan must receive fresh independent correctness and documentation rereviews with P0=P1=P2=P3=0 before W implementation acceptance. After normative incorporation,
...
The D4 v4 independent rereviews passed and the owner accepted the exact sentence. This normative addendum and its implementation plan still require their own independent rereviews before disputed W/H/Root code is accepted. GHCR,
server, Supabase, Qdrant, service, secret, schema, writer, scheduler, staging,
production, and deployment mutations remain outside this normative local scope.
