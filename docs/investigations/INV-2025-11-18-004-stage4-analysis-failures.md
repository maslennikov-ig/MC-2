...
export const PedagogicalPatternsSchema = z.object({
  ...
  theory_practice_ratio: z
    ...
    .refine(
      ...
      {
        message:
          'Theory and practice percentages must sum to 100 (e.g., "30:70", "50:50", "70:30")',
      }
    ),
...
**Short-term (P1 - Prevent future occurrences)**: 2. ✅ **Solution 2**: Enhanced LLM prompt with examples

**Optional (P2 - Additional safety net)**: 3. ⚠️ **Solution 3**: Defensive validation with auto-repair (if Solution 2 insufficient)
