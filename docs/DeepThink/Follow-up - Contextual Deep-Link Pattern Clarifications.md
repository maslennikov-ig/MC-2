...
- **Result:** Go to **ROOT** view. (Do _not_ close the panel).
...
- _User starts configuring a Quiz, types custom instructions, then clicks the Audio icon in the Asset Dock._
- **Result:** Trigger an Alert: _"Discard unsaved quiz settings? [Cancel] [Discard]"_.
