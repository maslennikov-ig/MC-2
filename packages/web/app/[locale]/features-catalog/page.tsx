...
export default function FeaturesLanding() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      {/* Progress Bar */}
      <motion.div
        className="fixed top-0 right-0 left-0 z-50 h-1 origin-left bg-gradient-to-r from-purple-600 to-cyan-600"
      ...
      {sectionsData.map((section, sectionIndex) => (
        <SectionBlock key={section.id} section={section} index={sectionIndex} />
      ))}
