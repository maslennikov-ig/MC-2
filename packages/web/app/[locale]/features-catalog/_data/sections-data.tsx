    ...
    features: [
      {
        ...
        benefit:
          'Превращение любых корпоративных документов (PDF, Word, Excel, PowerPoint) в полноценные обучающие курсы за 5 минут вместо 2-3 недель. Экономия сотен часов работы методистов на каждом курсе.',
      ...
      },
      {
        ...
        benefit:
          'Гарантия актуальности всех учебных материалов. Когда обновляется регламент или процедура, курс обновляется автоматически. 0% риска обучения по устаревшим материалам.',
      ...
      },
      {
        ...
        benefit:
          'AI анализирует переписку, записи встреч, email и автоматически создает базу знаний. 40% корпоративного обучения происходит неформально - теперь оно будет зафиксировано.',
      ...
      },
      {
        ...
        benefit:
          'Автоматическое превращение записанных совещаний, тренингов и презентаций в структурированные курсы с ключевыми моментами и тестами.',
      ...
      },
      {
        ...
        benefit:
          'Автоматическая генерация обучающих материалов на основе реальных проблем и их решений. Предотвращение повторения ошибок.',
      ...
      },
      {
        ...
        benefit:
          'Создание курса на 40+ языках из одного документа. Экономия на переводах и локализации для международных компаний.',
      ...
      },
      {
        ...
        benefit:
          'Из одного источника генерируются: текстовые уроки, видео с AI-аватаром, подкасты, инфографика, интерактивные симуляции.',
      ...
      },
      {
        ...
        benefit:
          'Создание профессиональных видеокурсов с виртуальным лектором без студии и актеров. Экономия 60-80% на производстве видео.',
        icon: <Video className="h-5 w-5" />,
        color: 'text-pink-500',
        gradient: 'from-pink-400 to-pink-600',
        stats: '-80% затрат',
      },
      {
        ...
        benefit:
          'AI создает проверочные задания разного уровня сложности на основе материала курса. Экономия 10+ часов на каждом курсе.',
      ...
      },
      {
        ...
        benefit:
          'Автоматическая генерация бизнес-кейсов, ролевых игр и сценариев для отработки навыков в безопасной среде.',
    ...
    features: [
      {
        ...
        benefit:
          'Каждый получает уникальный путь обучения на основе его роли, уровня знаний и карьерных целей. Повышение эффективности обучения на 60%.',
      ...
      },
      {
        ...
        benefit:
          'AI автоматически упрощает или усложняет материал в зависимости от успехов ученика. Оптимальный уровень вызова для максимального усвоения.',
        icon: <Layers className="h-5 w-5" />,
        color: 'text-cyan-500',
      ...
      },
      {
        ...
        benefit:
          'Каждый сотрудник получает виртуального наставника, который отвечает на вопросы, мотивирует и направляет. В 100 раз дешевле живого коуча при круглосуточной доступности.',
      ...
      },
      {
        ...
        benefit:
          'Система определяет предпочтительный стиль (визуальный, аудиальный, кинестетический) и подстраивает подачу материала.',
      ...
      },
      {
        ...
        benefit:
          'Виртуальный психолог помогает преодолеть страх неудачи, прокрастинацию и синдром самозванца. +45% завершаемость сложных программ.',
      ...
      },
      {
        ...
        benefit:
          'AI рекомендует следующие курсы на основе интересов, целей и пробелов в знаниях. Непрерывное развитие без усилий.',
      ...
      },
      {
        ...
        benefit:
          'AI определяет лучшее время для обучения каждого сотрудника и отправляет напоминания. +45% возвращаемость к обучению.',
    ...
    features: [
      {
        ...
        benefit:
          'Прямое доказательство влияния обучения на продажи, качество, NPS. Обоснование бюджета L&D с точными цифрами ROI.',
      ...
      },
      {
        ...
        benefit:
          'AI предсказывает, какие навыки устареют через 6-18 месяцев. Проактивная переквалификация до потери продуктивности.',
        icon: <TrendingUp className="h-5 w-5" />,
      ...
      },
      {
        ...
        benefit:
          'Тепловая карта навыков показывает слабые места команды. Точечное обучение там, где это необходимо.',
        icon: <Target className="h-5 w-5" />,
        color: 'text-green-500',
        gradient: 'from-green-400 to-green-600',
      },
      {
        ...
        benefit:
          'Прогноз будущей производительности сотрудника на основе его обучения. Выявление high-performers на ранней стадии.',
      ...
      },
      {
        ...
        benefit:
          'Расчет экономического эффекта до запуска обучения. Data-driven решения об инвестициях в L&D.',
      ...
      },
      {
        ...
        benefit:
          'Отслеживание, как полученные знания используются в работе. Доказательство эффективности обучения.',
      ...
      },
      {
        ...
        benefit:
          'Мгновенное выявление проблемных моментов в курсах. Оптимизация контента на основе поведения пользователей.',
      ...
      },
      {
        ...
        benefit:
          'Сравнение программ обучения с лучшими практиками отрасли. Понимание конкурентной позиции.',
      ...
      },
      {
        ...
        benefit:
          'AI определяет эмоциональное состояние учащихся и адаптирует подход. Снижение стресса и выгорания.',
        icon: <Heart className="h-5 w-5" />,
        color: 'text-green-500',
        gradient: 'from-green-400 to-green-600',
      },
      {
        ...
        benefit:
          'Выявление сотрудников с риском ухода на основе их вовлеченности в обучение. Превентивные меры удержания.',
        icon: <Shield className="h-5 w-5" />,
        color: 'text-emerald-500',
        gradient: 'from-emerald-400 to-emerald-600',
      },
    ...
    features: [
      {
        ...
        benefit:
          'Соревнования между отделами и филиалами повышают вовлеченность на 89%. Обучение становится увлекательным.',
        icon: <Trophy className="h-5 w-5" />,
      ...
      },
      {
        ...
        benefit:
          '150+ достижений разной редкости мотивируют продолжать обучение. Визуальное отображение прогресса и экспертизы.',
        icon: <Award className="h-5 w-5" />,
        color: 'text-red-500',
      ...
      },
      {
        ...
        benefit:
          '3 ежедневных задания поддерживают привычку учиться. Формирование культуры непрерывного обучения.',
      ...
      },
      {
        ...
        benefit:
          'Серии последовательных дней обучения с наградами. 20% увеличение ежедневных активных пользователей.',
        icon: <Zap className="h-5 w-5" />,
        color: 'text-red-500',
        gradient: 'from-red-400 to-red-600',
        stats: '+20% DAU',
      },
      {
        ...
        benefit:
          'Сезонные программы с эксклюзивными наградами. Превращение обучения в увлекательное путешествие.',
      ...
      },
      {
        ...
        benefit:
          'Дуэли знаний в реальном времени. Социальное обучение через дружеское соперничество.',
      ...
      },
      {
        ...
        benefit:
          'Командные задания, требующие совместной работы. Укрепление командного духа через обучение.',
      ...
      },
      {
        ...
        benefit:
          'Заработанные баллы можно обменять на реальные призы. Материальная мотивация к обучению.',
        icon: <DollarSign className="h-5 w-5" />,
        color: 'text-red-500',
        gradient: 'from-red-400 to-red-600',
      },
      {
        ...
        benefit:
          'Объединение в группы по интересам для взаимной поддержки. Снижение отсева через социальные связи.',
        icon: <Shield className="h-5 w-5" />,
        color: 'text-orange-500',
        gradient: 'from-orange-400 to-orange-600',
      },
      {
        ...
        benefit:
          'Обучение через захватывающие истории и приключения. 135% более быстрое выполнение задач.',
    ...
    features: [
      {
        ...
        benefit:
          'Биржа, где сотрудники могут найти и забронировать время эксперта. +55% эффективность решения сложных задач.',
      ...
      },
      {
        ...
        benefit:
          'Сотрудники получают баллы за обучение коллег. Трансформация неявных знаний в корпоративные активы.',
        icon: <Users className="h-5 w-5" />,
        color: 'text-purple-500',
        gradient: 'from-purple-400 to-purple-600',
      },
      {
        ...
        benefit:
          'Twitter-подобная лента с микро-инсайтами от коллег. 69% увеличение вовлеченности через социальный элемент.',
        icon: <MessageSquare className="h-5 w-5" />,
        color: 'text-indigo-500',
        gradient: 'from-indigo-400 to-indigo-600',
      ...
      },
      {
        ...
        benefit:
          'Автоматический подбор ментора на основе целей и совместимости. 70% completion rate с ментором vs 30% без.',
        icon: <PersonStanding className="h-5 w-5" />,
        color: 'text-purple-500',
        gradient: 'from-purple-400 to-purple-600',
        stats: '70% vs 30%',
      },
      {
        ...
        benefit:
          'Автоматическое формирование учебных групп по интересам. Взаимная поддержка и мотивация.',
      ...
      },
      {
        ...
        benefit:
          'Совместное создание базы знаний компании. Сохранение экспертизы уходящих сотрудников.',
        icon: <BookOpen className="h-5 w-5" />,
        color: 'text-purple-500',
        gradient: 'from-purple-400 to-purple-600',
      },
      {
        ...
        benefit:
          'Место для вопросов и ответов с автоматической категоризацией. Быстрое решение проблем.',
        icon: <MessageSquare className="h-5 w-5" />,
        color: 'text-indigo-500',
        gradient: 'from-indigo-400 to-indigo-600',
      },
      ...
      },
      {
        ...
        benefit:
          'Платформа для sharing успешных кейсов между подразделениями. Масштабирование успеха.',
        icon: <Award className="h-5 w-5" />,
        color: 'text-indigo-500',
        gradient: 'from-indigo-400 to-indigo-600',
      },
      {
        ...
        benefit:
          'AI организует неформальные встречи для обмена знаниями. Укрепление горизонтальных связей.',
        icon: <Users className="h-5 w-5" />,
        color: 'text-purple-500',
        gradient: 'from-purple-400 to-purple-600',
      },
    ...
    features: [
      {
        ...
        benefit:
          'Обучение вписывается в любой график. 60% сотрудников учатся ежедневно vs 10% при традиционном подходе.',
        icon: <Calendar className="h-5 w-5" />,
      ...
      },
      {
        ...
        benefit:
          'Контекстные подсказки появляются когда нужно решить задачу. Just-in-time learning повышает применение на 70%.',
        icon: <Zap className="h-5 w-5" />,
        color: 'text-purple-500',
        gradient: 'from-purple-400 to-purple-600',
        stats: '+70% применения',
    ...
    features: [
      {
        ...
        benefit:
          '100% прохождение compliance-тренингов без напоминаний HR. Избежание многомиллионных штрафов от регуляторов.',
        icon: <Shield className="h-5 w-5" />,
        color: 'text-red-500',
        gradient: 'from-red-400 to-red-600',
        stats: '0 штрафов',
      ...
      },
      {
        ...
        benefit:
          'Система сама напоминает о необходимости пересертификации. 0% просроченных лицензий.',
        icon: <Calendar className="h-5 w-5" />,
        color: 'text-red-500',
        gradient: 'from-red-400 to-red-600',
        stats: '0% просрочек',
      ...
      },
      {
        ...
        benefit:
          'Учет требований разных юрисдикций для международных компаний. Один курс - все страны.',
        icon: <Globe className="h-5 w-5" />,
        color: 'text-red-500',
        gradient: 'from-red-400 to-red-600',
      },
      ...
      },
      {
        ...
        benefit:
          'История всех изменений с возможностью отката. Доказательство соответствия на любую дату.',
        icon: <Clock className="h-5 w-5" />,
        color: 'text-red-500',
        gradient: 'from-red-400 to-red-600',
      },
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        benefit:
          'Наложение подсказок на реальное оборудование через смартфон. -50% ошибок при сложных операциях.',
        icon: <Layers className="h-5 w-5" />,
        color: 'text-blue-500',
        gradient: 'from-blue-400 to-blue-600',
        stats: '-50% ошибок',
      },
      {
        ...
        benefit:
          'Цифровые двойники топ-специалистов для обучения. Сохранение уникальной экспертизы навсегда.',
        icon: <Bot className="h-5 w-5" />,
        color: 'text-cyan-500',
        gradient: 'from-cyan-400 to-cyan-600',
      },
      {
        ...
        benefit:
          'Прямая загрузка знаний в мозг (пилотный проект). Обучение за минуты вместо месяцев.',
        icon: <Cpu className="h-5 w-5" />,
        color: 'text-blue-500',
        gradient: 'from-blue-400 to-blue-600',
      },
      ...
      },
      {
        ...
        benefit:
          'Виртуальные копии реальных бизнес-процессов для обучения. Эксперименты без последствий.',
        icon: <Layers className="h-5 w-5" />,
        color: 'text-blue-500',
        gradient: 'from-blue-400 to-blue-600',
      },
      ...
      },
      {
        ...
        benefit:
          'Изменение подачи на основе пульса и eye-tracking. Оптимальная когнитивная нагрузка.',
        icon: <Heart className="h-5 w-5" />,
        color: 'text-blue-500',
        gradient: 'from-blue-400 to-blue-600',
      },
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        benefit:
          'Защита данных пациентов через правильное обучение. Избежание многомиллионных штрафов.',
        icon: <Heart className="h-5 w-5" />,
        color: 'text-amber-500',
        gradient: 'from-amber-400 to-amber-600',
      },
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        benefit:
          'Развитие навыков, которые не заменит AI. Повышение ценности человеческого капитала.',
        icon: <Target className="h-5 w-5" />,
        color: 'text-teal-500',
    ...
    features: [
      {
        ...
        benefit:
          'Стоимость создания курса сопоставима с чашкой кофе. Возможность обучать всех сотрудников, а не только избранных.',
        icon: <DollarSign className="h-5 w-5" />,
        color: 'text-green-500',
        gradient: 'from-green-400 to-green-600',
        stats: '-99% затрат',
      },
      {
        ...
        benefit:
          'Новые сотрудники выходят на продуктивность за 45 дней вместо 90. Существенная экономия на каждом новом сотруднике.',
        icon: <Clock className="h-5 w-5" />,
        color: 'text-teal-500',
        gradient: 'from-teal-400 to-teal-600',
        stats: '-43% времени',
      },
      {
        ...
        benefit:
          'Сотрудники остаются, когда компания инвестирует в их развитие. Огромная экономия на поиске и обучении замены.',
        icon: <Heart className="h-5 w-5" />,
        color: 'text-green-500',
        gradient: 'from-green-400 to-green-600',
        stats: '-27% текучести',
      },
      {
        ...
        benefit:
          'L&D-команда фокусируется на стратегии, а не на рутине. Больше impact с меньшими ресурсами.',
        icon: <Cpu className="h-5 w-5" />,
        color: 'text-teal-500',
        gradient: 'from-teal-400 to-teal-600',
        stats: '-70% рутины',
      ...
      },
      {
        ...
        benefit:
          'Внутренняя экспертиза заменяет дорогих консультантов. Экономия миллионов рублей в год на внешнем обучении.',
        icon: <Users className="h-5 w-5" />,
        color: 'text-green-500',
        gradient: 'from-green-400 to-green-600',
      },
    ...
    features: [
      {
        ...
        benefit:
          'Бесшовная работа с Диадок, СБИС, Контур.Диадок. Автоматический импорт регламентов и инструкций.',
        icon: <Link2 className="h-5 w-5" />,
        color: 'text-red-500',
        gradient: 'from-red-400 to-red-600',
      },
      {
        ...
        benefit:
          'Нативная интеграция с 1С:Предприятие, 1С:ЗУП, Галактика ERP. Синхронизация данных о сотрудниках.',
        icon: <Briefcase className="h-5 w-5" />,
        color: 'text-blue-500',
        gradient: 'from-blue-400 to-blue-600',
      },
      {
        ...
        benefit:
          'Полное соответствие российскому законодательству. Хранение данных на территории РФ.',
        icon: <Shield className="h-5 w-5" />,
        color: 'text-red-500',
        gradient: 'from-red-400 to-red-600',
      },
      ...
      },
      {
        ...
        benefit:
          'Библиотека курсов по охране труда, пожарной безопасности, ГО и ЧС согласно российским требованиям.',
        icon: <BookOpen className="h-5 w-5" />,
        color: 'text-red-500',
        gradient: 'from-red-400 to-red-600',
      },
      {
        ...
        benefit:
          'Интеграция с Directum, Docsvision, ТЕЗИС. Автоматическое обучение при изменении процессов.',
        icon: <FileText className="h-5 w-5" />,
        color: 'text-blue-500',
        gradient: 'from-blue-400 to-blue-600',
      },
      {
        ...
        benefit:
          'Использование российских и китайских AI-моделей. Независимость от западных технологий.',
        icon: <Bot className="h-5 w-5" />,
        color: 'text-red-500',
        gradient: 'from-red-400 to-red-600',
      },
      {
        ...
        benefit:
          'Встраивание в корпоративные версии Telegram, VK Teams. Обучение там, где общаются сотрудники.',
        icon: <MessageSquare className="h-5 w-5" />,
        color: 'text-blue-500',
        gradient: 'from-blue-400 to-blue-600',
      },
      {
        ...
        benefit:
          'Генерация курсов на татарском, башкирском, чеченском и других языках народов России.',
        icon: <Languages className="h-5 w-5" />,
        color: 'text-red-500',
        gradient: 'from-red-400 to-red-600',
      },
      ...
      },
      {
        ...
        benefit:
          'Автоматическая публикация данных об обучении. Повышение привлекательности работодателя.',
        icon: <Briefcase className="h-5 w-5" />,
        color: 'text-red-500',
        gradient: 'from-red-400 to-red-600',
      },
      ...
      },
      {
        ...
        benefit:
          'Использование ГОСТ-алгоритмов и квалифицированной ЭП. Юридическая значимость сертификатов.',
        icon: <Lock className="h-5 w-5" />,
        color: 'text-red-500',
        gradient: 'from-red-400 to-red-600',
      },
    ...
    features: [
      {
        ...
        benefit:
          'Автоматическое обновление данных между системами. -70% административной работы, 0 ошибок в данных.',
        icon: <Link2 className="h-5 w-5" />,
        color: 'text-teal-500',
        gradient: 'from-teal-400 to-teal-600',
      ...
      },
      {
        ...
        benefit:
          'Автоматическое создание learning goals из performance reviews. Прямая связь обучения с карьерным ростом.',
        icon: <TrendingUp className="h-5 w-5" />,
        color: 'text-blue-500',
        gradient: 'from-blue-400 to-blue-600',
      },
      {
        ...
        benefit:
          'Обучение прямо в рабочем чате. 70% лучше применение знаний благодаря контекстной подаче.',
        icon: <MessageSquare className="h-5 w-5" />,
        color: 'text-teal-500',
        gradient: 'from-teal-400 to-teal-600',
        stats: '+70% применения',
      },
      {
        ...
        benefit:
          'Автоматическое планирование обучения в свободные слоты. +15% регулярности занятий.',
        icon: <Calendar className="h-5 w-5" />,
        color: 'text-blue-500',
        gradient: 'from-blue-400 to-blue-600',
      ...
      },
      {
        ...
        benefit:
          'Обучение продажам на основе реальных данных о клиентах. Персонализированные сценарии.',
        icon: <Briefcase className="h-5 w-5" />,
        color: 'text-teal-500',
        gradient: 'from-teal-400 to-teal-600',
      },
      ...
      },
      {
        ...
        benefit:
          'Автоматическое создание курсов из новых регламентов. Мгновенное обучение изменениям.',
        icon: <FileText className="h-5 w-5" />,
        color: 'text-teal-500',
        gradient: 'from-teal-400 to-teal-600',
      },
