  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          className="flex items-center gap-2 px-2 text-gray-300 hover:bg-slate-800 hover:text-white"
        >
          ...
          <span className="hidden max-w-[150px] truncate md:inline">{user.name || user.email}</span>
          {user.role === 'superadmin' && (
            <Badge className="ml-2 border-purple-600/30 bg-purple-600/20 text-purple-400">
              Admin
            </Badge>
          )}
        </Button>
