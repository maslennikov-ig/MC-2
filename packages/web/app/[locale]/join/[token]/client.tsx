    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 p-4 dark:bg-gray-950">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>{t('description', { org: organization.name })}</CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="bg-muted/50 space-y-3 rounded-lg border p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-muted-foreground text-sm">{t('orgLabel')}</p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-muted-foreground text-sm">{t('roleLabel')}</p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-muted-foreground text-sm">{t('expiresLabel')}</p>
        ...
        <CardFooter className="flex flex-col gap-3">
          {isAuthenticated ? (
            ...
            <>
              ...
              <p className="text-muted-foreground mt-2 text-center text-xs">{t('authHint')}</p>
            </>
          )}
        </CardFooter>
      </Card>
