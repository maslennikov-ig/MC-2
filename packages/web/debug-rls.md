...
const cookie = document.cookie
  .split(';')
  .find((c) => c.includes('sb-diqooqbuchsliypgwksu-auth-token'))
  ?.split('=')[1]
...
// Тест запроса
fetch(
  'https://diqooqbuchsliypgwksu.supabase.co/rest/v1/generation_trace?select=*&course_id=eq.6e6fbbcd-afd1-460d-b479-3c344cff7f01&limit=10',
  {
    headers: {
      apikey:
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRpcW9vcWJ1Y2hzbGl5cGd3a3N1Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTk5OTczNTIsImV4cCI6MjA3NTU3MzM1Mn0.NgS0kl5nL0HR5S3RJw1TeGQNaZy3xmhzmrBLcdBAn3w',
