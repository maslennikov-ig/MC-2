...
export const GRAPH_TRANSLATIONS: GraphTranslations & {
  ...
  actions: {
    ...
    approving: { ru: 'Одобряем...', en: 'Approving...' },
    lessonsApproved: { ru: 'Одобрено уроков', en: 'Lessons approved' },
    noLessonsToApprove: { ru: 'Нет уроков для одобрения', en: 'No lessons to approve' },
    skipped: { ru: 'пропущено', en: 'skipped' },
    failedToApproveLessons: { ru: 'Не удалось одобрить уроки', en: 'Failed to approve lessons' },
  ...
  stageDescriptions: {
    ...
    stage_3: {
      ru: 'Проверка приоритетов документов (установленных пользователем).',
      en: 'Verifying document priorities (user-defined).',
    },
    stage_4: {
  ...
  completionMessages: {
    ...
    stage_3: { ru: 'Приоритеты подтверждены', en: 'Priorities confirmed' },
  ...
  stage1: {
    ...
    lessonsCount: { ru: 'Уроков', en: 'Lessons' },
    sectionsCount: { ru: 'Секции', en: 'Sections' },
    language: { ru: 'Язык', en: 'Language' },
    courseSize: { ru: 'Размер', en: 'Size' },
    lessonDuration: { ru: 'мин/урок', en: 'min/lesson' },
