...
export const themeClasses = {
  ...
  badge: {
    completed:
      'bg-[hsl(var(--success))] text-[hsl(var(--success-foreground))] border-[hsl(var(--success))]/20',
    generating: 'bg-[hsl(var(--info))] text-[hsl(var(--info-foreground))]',
    draft:
      'bg-[hsl(var(--status-draft))]/10 text-[hsl(var(--status-draft))] border-[hsl(var(--status-draft))]/20',
    failed:
      'bg-[hsl(var(--danger))] text-[hsl(var(--danger-foreground))] border-[hsl(var(--danger))]/20',
  },
  ...
  difficulty: {
    ...
    intermediate:
      'border-[hsl(var(--warning))]/30 text-[hsl(var(--warning))] bg-[hsl(var(--warning))]/10',
