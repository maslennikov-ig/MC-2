...
describe('Validation and Sanitization', () => {
  describe('sanitize', () => {
    it('should sanitize HTML content', () => {
      const dirtyHtml =
        '<script>alert("xss")</script><p>Safe content</p><a href="javascript:void(0)">Link</a>'
  ...
  describe('fileValidation', () => {
    it('should validate file types correctly', () => {
      ...
      const isPdfValid = fileValidation.validateFileType(
        pdfFile,
        fileValidation.fileTypes.documents
      )
      const isExeValid = fileValidation.validateFileType(
        invalidFile,
        fileValidation.fileTypes.documents
      )
