...
export function PageTransitionLoader() {
  ...
  useEffect(() => {
    ...
    const handlePopState = () => {
      ...
      // For back/forward navigation, check if page loaded quickly
      // Next.js often renders cached pages instantly
      requestAnimationFrame(() => {
        requestAnimationFrame(() => {
          // If document is ready, stop loading
  ...
  }, [handleLinkClick, handleButtonClick, startLoading, stopLoading])
  ...
  useEffect(() => {
    ...
    const timeout = setTimeout(() => {
      stopLoading()
    }, 5000) // 5 second max (reduced from 15s)
