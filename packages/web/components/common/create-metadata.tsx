...
export default function CreateMetadata() {
  useEffect(() => {
    ...
    metaDescription.setAttribute(
      'content',
      'Создайте профессиональный образовательный курс за несколько минут. Загрузите документы, выберите стиль изложения и получите готовый курс с видео, аудио и интерактивными тестами.'
    )
    ...
    metaKeywords.setAttribute(
      'content',
      'создать курс, генерация курсов, AI создание курсов, загрузка документов, автоматическое создание, обучающие материалы'
    )
    ...
    const ogTags = [
      { property: 'og:title', content: 'Создать курс | MegaCampusAI' },
      {
        ...
        content:
          'Создайте профессиональный образовательный курс за несколько минут с помощью искусственного интеллекта',
      },
    ...
    const twitterTags = [
      ...
      { name: 'twitter:title', content: 'Создать курс | MegaCampusAI' },
      {
        ...
        content: 'Создайте профессиональный образовательный курс за несколько минут с помощью AI',
      },
      {
        name: 'twitter:image',
        content: `${window.location.origin}/images/create-twitter-image.png`,
      },
    ]
    ...
    let jsonLdScript = document.querySelector(
      'script[type="application/ld+json"][data-page="create"]'
    )
    if (!jsonLdScript) {
