...
export default function Logo({
  ...
  const shouldShowText =
    variant === 'icon' ? showText === true && textPosition !== undefined : showText
  ...
  const content = (
    <div className={cn('flex items-center', textPosition === 'bottom' ? 'flex-col' : 'flex-row')}>
  ...
  return (
    <div className={cn('relative inline-flex items-center select-none', className)}>{content}</div>
  )
}
