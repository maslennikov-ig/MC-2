    ...
    <main className="absolute right-4 bottom-4 left-4 z-20 max-w-full sm:right-auto sm:bottom-6 sm:left-6 sm:max-w-2xl md:bottom-8 md:left-8">
      <div className="text-left">
        ...
        >
          ...
          <span className="relative z-10 text-xs font-normal text-white/95">{t('badge')}</span>
        </div>
        ...
        >
          <span className="font-medium italic">{t('title1')}</span>
          <span className="font-light"> {t('title2')}</span>
          <br />
          <span className="font-light tracking-tight text-white">{t('title3')}</span>
        </h1>
