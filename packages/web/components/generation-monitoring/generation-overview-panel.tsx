      ...
      <motion.div variants={item}>
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">Current pipeline state</p>
          </CardContent>
        </Card>
      </motion.div>
      ...
      <motion.div variants={item}>
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">Cumulative LLM cost</p>
          </CardContent>
        </Card>
      </motion.div>
      ...
      <motion.div variants={item}>
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">Total tokens processed</p>
          </CardContent>
        </Card>
      </motion.div>
      ...
      <motion.div variants={item}>
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">Since first activity</p>
          </CardContent>
        </Card>
      </motion.div>
    </motion.div>
