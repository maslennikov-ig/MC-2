    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          success:
            'border-green-500/20 bg-green-50 dark:bg-green-950/50 text-green-900 dark:text-green-100',
          error: 'border-red-500/20 bg-red-50 dark:bg-red-950/50 text-red-900 dark:text-red-100',
          warning:
            'border-yellow-500/20 bg-yellow-50 dark:bg-yellow-950/50 text-yellow-900 dark:text-yellow-100',
