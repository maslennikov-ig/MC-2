  ...
  'flex h-9 w-full rounded-md border bg-transparent px-3 py-1 text-base shadow-sm transition-all duration-200 file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm',
  {
    variants: {
      variant: {
        ...
        error:
          'border-red-500 focus-visible:ring-1 focus-visible:ring-red-500 bg-red-50/50 dark:bg-red-950/20',
        success:
          'border-green-500 focus-visible:ring-1 focus-visible:ring-green-500 bg-green-50/50 dark:bg-green-950/20',
        warning:
          'border-yellow-500 focus-visible:ring-1 focus-visible:ring-yellow-500 bg-yellow-50/50 dark:bg-yellow-950/20',
      },
    },
    defaultVariants: {
      variant: 'default',
