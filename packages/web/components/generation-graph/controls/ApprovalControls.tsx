  ...
  if (variant === 'prominent') {
    return (
      <div
        ...
        onKeyDown={(e) => {
          if (isProcessing || isRestarting) return
        ...
        tabIndex={0}
        role="group"
        aria-label="Stage approval controls"
      >
        <Button
          size="compact"
    ...
    >
      <Button
        ...
        className={cn(
          ...
          // Dark mode
          'dark:border-emerald-700 dark:text-emerald-400 dark:hover:bg-emerald-900/30'
        )}
        data-testid="approval-approve-btn"
      >
        {isProcessing && action === 'approve' ? (
      ...
      {showRegenerate && (
        <Button
          ...
          className={cn(
            ...
            // Dark mode
            'dark:border-orange-700 dark:text-orange-400 dark:hover:bg-orange-900/30'
          )}
          data-testid="approval-regenerate-btn"
        >
          {isRegenerating ? (
