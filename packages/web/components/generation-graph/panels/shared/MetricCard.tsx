...
export const MetricCard = ({
  ...
  const variantStyles = {
    default: {
      ...
      border:
        'border-slate-200 hover:border-blue-400 dark:border-slate-700/50 dark:hover:border-cyan-500/50',
    ...
    success: {
      ...
      border:
        'border-emerald-200 hover:border-emerald-400 dark:border-emerald-700/50 dark:hover:border-emerald-500/50',
    ...
    warning: {
      ...
      border:
        'border-amber-200 hover:border-amber-400 dark:border-amber-700/50 dark:hover:border-amber-500/50',
    ...
    error: {
      ...
      border:
        'border-red-200 hover:border-red-400 dark:border-red-700/50 dark:hover:border-red-500/50',
  ...
  return (
    ...
    >
      ...
      {/* Value */}
      <div className={cn('font-mono text-2xl font-semibold', styles.value)}>{value}</div>
    </div>
  )
}
