...
export const OutputTab = ({
  ...
  const t = useTranslations('generation.outputTab')
  ...
  if (isEmpty) {
    return (
      <div className="text-muted-foreground flex flex-col items-center justify-center py-8">
        <CheckCircle2 className="text-success mb-2 h-8 w-8" />
        <p className="text-sm font-medium">{t('stageCompleted')}</p>
        <p className="text-xs">{t('noOutputData')}</p>
      </div>
    )
  }
