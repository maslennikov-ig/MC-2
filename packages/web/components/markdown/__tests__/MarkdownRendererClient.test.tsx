...
vi.mock('streamdown', () => ({
  Streamdown: ({ children, parseIncompleteMarkdown }: any) => (
    <div data-testid="streamdown" data-parse-incomplete={String(parseIncompleteMarkdown)}>
      {children}
    </div>
  ),
}))
...
describe('MarkdownRendererClient - Contract Tests', () => {
  describe('basic rendering', () => {
    it('should render markdown content in wrapper div', () => {
      const { container } = render(<MarkdownRendererClient content="Hello World" />)
  ...
  describe('streaming mode', () => {
    ...
    it('should handle incomplete markdown in streaming mode', () => {
      ...
      render(<MarkdownRendererClient content={incompleteMarkdown} isStreaming={true} />)
  ...
  describe('empty content handling', () => {
    ...
    it('should maintain wrapper className even with empty content', () => {
      const { container } = render(<MarkdownRendererClient content="" preset="chat" />)
  ...
  describe('preset className application', () => {
    ...
    it('should apply chat preset className explicitly', () => {
      const { container } = render(<MarkdownRendererClient content="Test" preset="chat" />)
    ...
    it('should apply minimal preset className', () => {
      const { container } = render(<MarkdownRendererClient content="Test" preset="minimal" />)
  ...
  describe('feature overrides', () => {
    it('should accept codeHighlight feature override', () => {
      ...
      const { container } = render(
        <MarkdownRendererClient content="Test" features={{ codeHighlight: false }} />
      )
    ...
    it('should accept responsiveTables feature override', () => {
      const { container } = render(
        <MarkdownRendererClient content="Test" features={{ responsiveTables: true }} />
      )
  ...
  describe('performance: preset constraint verification', () => {
    it('should enforce chat/minimal presets only for optimal streaming performance', () => {
      ...
      const validMinimal = <MarkdownRendererClient content="Test" preset="minimal" />
      ...
      const _invalidLesson = <MarkdownRendererClient content="Test" preset="lesson" />

      // @ts-expect-error - 'preview' not allowed for streaming renderer
      const _invalidPreview = <MarkdownRendererClient content="Test" preset="preview" />
    })
  })
})
