 ...
 * ```
 */
export function Heading({ level, id, children, showAnchor = true, className }: HeadingProps) {
  ...
  const headingClasses = cn('group relative scroll-mt-20', className)
        ...
        <a
          ...
          aria-label={
            copied
              ...
              : `Copy link to ${typeof children === 'string' ? children : 'this section'}`
          }
          aria-live="polite"
