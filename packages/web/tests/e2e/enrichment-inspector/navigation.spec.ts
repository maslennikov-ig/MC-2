...
import { mockEnrichmentApi, waitForAnimation } from './fixtures/enrichment-fixtures'
...
test.describe('Enrichment Inspector Navigation', () => {
  ...
  test.describe('Discovery Card Navigation', () => {
    test('should navigate to create view when clicking discovery card', async ({ page }) => {
  ...
  test.describe('Back Navigation', () => {
    ...
    test('should navigate back from detail view to root', async ({ page }) => {
      ...
      // Navigate to course and open inspector
      await inspectorPage.navigateToLesson(TEST_COURSE_SLUG, 'lesson-with-enrichments')
  ...
  test.describe('History Stack', () => {
    test('should preserve history stack for multiple navigations', async ({ page }) => {
      // Setup: Mock API for lesson with enrichments
      await mockEnrichmentApi(page, 'lesson-with-enrichments')
    ...
    test('should maintain correct navigation state after create and back', async ({ page }) => {
      // Setup: Mock API for empty lesson
      await mockEnrichmentApi(page, 'lesson-1')
  ...
  test.describe('Back Button Visibility', () => {
    ...
    test('back button should be hidden on root view with enrichments', async ({ page }) => {
      // Setup: Mock API for lesson with enrichments
      await mockEnrichmentApi(page, 'lesson-with-enrichments')
    ...
    test('back button visibility toggles correctly during navigation', async ({ page }) => {
      // Setup: Mock API for empty lesson
      await mockEnrichmentApi(page, 'lesson-1')
  ...
  test.describe('Cancel Button Navigation', () => {
    test('should return to root when clicking cancel on create view', async ({ page }) => {
      // Setup: Mock API for empty lesson
      await mockEnrichmentApi(page, 'lesson-1')
  ...
  test.describe('Header Title Updates', () => {
    ...
    test('should update title when navigating to create view', async ({ page }) => {
      // Setup: Mock API for empty lesson
      await mockEnrichmentApi(page, 'lesson-1')
  ...
  test.describe('Navigation with Existing Enrichments', () => {
    test('should show enrichment list instead of empty state', async ({ page }) => {
      // Setup: Mock API for lesson with enrichments
      await mockEnrichmentApi(page, 'lesson-with-enrichments')
    ...
    test('should navigate to detail view when clicking enrichment item', async ({ page }) => {
      // Setup: Mock API for lesson with enrichments
      await mockEnrichmentApi(page, 'lesson-with-enrichments')
