...
test.describe('Visual Regression Tests', () => {
    ...
    const darkModeToggle = page
      ...
      .or(
        page
          ...
          .or(page.locator('[aria-label*="dark"]').or(page.locator('[class*="theme"]')))
      )
  ...
  test('Course cards visual consistency', async ({ page }) => {
    ...
    const courseCards = page
      ...
      .or(page.locator('.course-card').or(page.locator('[class*="course"]').first()))
  ...
  test('Error state visual snapshot', async ({ page }) => {
    ...
    const errorElement = page
      ...
      .or(page.locator('.error').or(page.locator(':has-text("error")').first()))
