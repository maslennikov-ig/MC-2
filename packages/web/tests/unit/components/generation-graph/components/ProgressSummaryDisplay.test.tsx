...
const createAttemptSummary = (overrides: Partial<NodeAttemptSummary> = {}): NodeAttemptSummary => ({
  node: 'selfReviewer',
  attempt: 1,
  status: 'completed',
  resultLabel: 'PASS',
...
const createProgressSummary = (overrides: Partial<ProgressSummary> = {}): ProgressSummary => ({
  status: 'completed',
...
describe('ProgressSummaryDisplay', () => {
  describe('null/empty states', () => {
    it('should render null without crashing when progressSummary is null', () => {
      const { container } = render(<ProgressSummaryDisplay progressSummary={null} />)
      expect(container.firstChild).toBeNull()
    })

    it('should render null when progressSummary is undefined', () => {
      const { container } = render(<ProgressSummaryDisplay progressSummary={undefined} />)
      expect(container.firstChild).toBeNull()
    })
  })
  ...
  describe('compact view', () => {
    ...
    it('should include outcome in compact view when provided', () => {
      ...
      expect(screen.getByText(/Self-Review - Passed all checks/)).toBeInTheDocument()
    })
    ...
    it('should show status icon in compact view for generating status', () => {
      ...
      const { container } = render(<ProgressSummaryDisplay progressSummary={summary} compact />)
  ...
  describe('custom className', () => {
    it('should apply custom className in compact view', () => {
      ...
      const { container } = render(
        <ProgressSummaryDisplay progressSummary={summary} compact className="custom-class" />
      )
    ...
    it('should apply custom className in full view', () => {
      ...
      const { container } = render(
        <ProgressSummaryDisplay progressSummary={summary} className="custom-class" />
      )
...
describe('AttemptSummaryCard', () => {
  ...
  describe('latest badge', () => {
    ...
    it('should not show badge when isLatest=false', () => {
      ...
      render(<AttemptSummaryCard attempt={attempt} isLatest={false} language="en" />)
  ...
  describe('issues and actions', () => {
    ...
    it('should show actions performed', () => {
      ...
      expect(screen.getByText('Removed chatbot artifacts')).toBeInTheDocument()
    })
    ...
    it('should show outcome message', () => {
      ...
      expect(screen.getByText('Routed to judge for final evaluation')).toBeInTheDocument()
    })
  ...
  describe('metrics', () => {
    ...
    it('should not show metrics section when no metrics provided', () => {
      ...
      const { container } = render(<AttemptSummaryCard attempt={attempt} language="en" />)
  ...
  describe('custom className', () => {
    it('should apply custom className', () => {
      ...
      const { container } = render(
        <AttemptSummaryCard attempt={attempt} language="en" className="custom-card-class" />
      )
  ...
  describe('visual styling for isLatest', () => {
    it('should apply blue styling when isLatest=true', () => {
      ...
      const { container } = render(<AttemptSummaryCard attempt={attempt} isLatest language="en" />)
