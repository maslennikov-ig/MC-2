...
const messages = {
  ...
  'career-playbook': {
    ...
    viewer: {
      ...
      numericFactsTitle: 'Number review',
      numericFactsDescription:
        'Review exact values before publishing: KPIs, timelines, budgets, and percentages.',
      numericFactActionHint: 'Click a number to find it in the document.',
      numericFactOpenAriaLabel: 'Open number {value} in block {blockTitle}',
      ...
      numericFactStatusBenchmark: 'Benchmark',
      numericFactStatusNeedsReview: 'Review',
      numericFactStatusSuggested: 'Suggestion',
      numericFactStatusConflict: 'Conflict',
...
const ruMessages = {
  ...
  'career-playbook': {
    ...
    viewer: {
      ...
      numericFactOpenAriaLabel: 'Открыть число {value} в блоке {blockTitle}',
