 ...
 *
 * Usage:
 *   pnpm tsx scripts/test-model-glm-46-quality.ts
 */
 ...
 * QUALITY_TESTS_DIR=specs/008-generation-generation-json/quality-tests pnpm tsx scripts/test-model-glm-46-quality.ts
 */
