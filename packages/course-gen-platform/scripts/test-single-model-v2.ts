 ...
 *
 * Usage:
 *   pnpm tsx scripts/test-single-model-v2.ts <config-path> <model-slug>
 *
 * Example:
 *   pnpm tsx scripts/test-single-model-v2.ts docs/llm-testing/test-config-2025-11-13-v2.json kimi-k2-0905
 */
...
if (!configPath || !modelSlug) {
  console.error('Usage: pnpm tsx scripts/test-single-model-v2.ts <config-path> <model-slug>');
  console.error('Example: pnpm tsx scripts/test-single-model-v2.ts docs/llm-testing/test-config-2025-11-13-v2.json kimi-k2-0905');
  process.exit(1);
}
