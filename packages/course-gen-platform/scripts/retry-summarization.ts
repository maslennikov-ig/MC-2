 ...
 *
 * Usage: tsx scripts/retry-summarization.ts <courseId> <fileId1> [fileId2] ...
 *
 * Example:
 *   tsx scripts/retry-summarization.ts aa41261f-7006-4649-9cdf-dbf8aed69448 35a7579d-8782-47e9-86aa-03ebe0bbfcf3 3672f25e-2e5b-4839-a0bb-9c8d7e74959b
 */
...
async function main() {
  ...
  if (args.length < 2) {
    console.error('Usage: tsx scripts/retry-summarization.ts <courseId> <fileId1> [fileId2] ...');
    console.error('');
    console.error('Example:');
    console.error('  tsx scripts/retry-summarization.ts aa41261f-... 35a7579d-... 3672f25e-...');
    process.exit(1);
  }
