 ...
 *
 * Usage:
 *   npx tsx scripts/e2e-workflow-test.ts
 *   npx tsx scripts/e2e-workflow-test.ts --lessons=5  # Generate 5 lessons in Stage 6
 *   npx tsx scripts/e2e-workflow-test.ts --skip-stage6  # Skip lesson content generation
 */
