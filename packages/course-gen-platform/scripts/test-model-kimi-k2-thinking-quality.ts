 ...
 *
 * Usage:
 *   pnpm tsx scripts/test-model-kimi-k2-thinking-quality.ts
 */
 ...
 * QUALITY_TESTS_DIR=specs/008-generation-generation-json/quality-tests pnpm tsx scripts/test-model-kimi-k2-thinking-quality.ts
 */
