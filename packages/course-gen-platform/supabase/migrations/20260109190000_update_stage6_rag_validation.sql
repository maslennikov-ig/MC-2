-- Migration: Add RAG relevance validation to stage6_serial_generator prompt
-- Purpose: Instruct model to critically evaluate RAG chunk relevance before using
-- Date: 2026-01-09
-- Related: Fix for content misalignment when RAG chunks don't match lesson topic
-- Issue: Model was using irrelevant RAG chunks (e.g., event tickets for CRM B2B lesson)

-- ============================================================================
-- UPDATE STAGE 6 SERIAL GENERATOR PROMPT WITH RAG VALIDATION
-- ============================================================================
...
DO $$
BEGIN
  RAISE NOTICE 'Updated stage6_serial_generator prompt with RAG validation instructions (v2)';
END $$;
