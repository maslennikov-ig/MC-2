-- Migration: add Stage 6 quality ladder phase configs
-- Introduces config-driven auto last-chance and manual regeneration rungs.
...
ALTER TABLE llm_model_config ADD CONSTRAINT llm_model_config_phase_name_check CHECK (
  phase_name IN (
    ...
    'stage_6_auto_last_chance', 'stage_6_manual_regeneration',
...
SELECT v.* FROM (VALUES
  ('global', 'stage_6_auto_last_chance', 'z-ai/glm-5', 'qwen/qwen3.5-plus-02-15', 0.70, 8000, true, 'any', 'standard', 6, 128000, 0, 300000),
  ('global', 'stage_6_auto_last_chance', 'z-ai/glm-5', 'qwen/qwen3.5-plus-02-15', 0.70, 8000, true, 'any', 'extended', 6, 128000, 0, 300000),
  ('global', 'stage_6_manual_regeneration', 'openai/gpt-5.4', 'z-ai/glm-5', 0.70, 8000, true, 'any', 'standard', 6, 128000, 0, 300000),
  ('global', 'stage_6_manual_regeneration', 'openai/gpt-5.4', 'z-ai/glm-5', 0.70, 8000, true, 'any', 'extended', 6, 128000, 0, 300000)
