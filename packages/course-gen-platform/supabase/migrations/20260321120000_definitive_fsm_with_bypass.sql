-- Definitive FSM transition map: merges ALL original transitions + improvements
-- Fixes: stage_4_analyzing ↔ stage_4_clarifying back-transition,
--        app.bypass_fsm_validation support for restart_from_stage RPC
...
BEGIN
  ...
  -- Allow bypass for admin operations (restart_from_stage RPC)
  BEGIN
