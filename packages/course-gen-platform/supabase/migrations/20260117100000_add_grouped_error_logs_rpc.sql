-- Migration: add_grouped_error_logs_rpc
-- Purpose: Add RPC functions for server-side grouped error logs queries
-- This replaces in-memory grouping with efficient PostgreSQL GROUP BY
...
-- ============================================================================
-- 1. RPC function to get grouped error logs with pagination
-- ============================================================================
...
BEGIN
    ...
    SELECT
        ...
        ws.latest_job_type
    FROM with_status ws
    WHERE (p_status IS NULL OR COALESCE(ws.issue_status, 'new') = p_status)
...
'Returns error logs grouped by fingerprint with aggregated data. Supports filtering by severity, environment, search term, date range, and status.';

-- ============================================================================
-- 2. RPC function to get total count of grouped error logs (for pagination)
-- ============================================================================
