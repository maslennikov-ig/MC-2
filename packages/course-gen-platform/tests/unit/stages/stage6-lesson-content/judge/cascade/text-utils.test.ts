...
import { countSyllables, calculateFleschKincaid } from '@/stages/stage6-lesson-content/judge/cascade/text-utils';
...
describe('calculateFleschKincaid', () => {
    ...
    it('maxes out at 20', () => {
        const text = "Supercalifragilisticexpialidocious pseudopseudohypoparathyroidism pneumonoultramicroscopicsilicovolcanoconiosis. Floccinaucinihilipilification incomprehensibilities uncharacteristically.";
        const score = calculateFleschKincaid(text);
