 ...
 *
 * Usage:
 *   pnpm tsx experiments/models/test-models-with-quality.ts
 */
 ...
 * QUALITY_TESTS_DIR=specs/008-generation-generation-json/quality-tests pnpm tsx experiments/models/test-models-with-quality.ts
 */
...
Output the JSON directly:`;
  ...
  async runAllTests(): Promise<void> {
    ...
    log('Command: pnpm tsx experiments/models/analyze-quality.ts', 'info');
  }
}
