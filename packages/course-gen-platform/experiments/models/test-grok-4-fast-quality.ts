 ...
 *
 * Usage:
 *   pnpm tsx experiments/models/test-grok-4-fast-quality.ts
 */
 ...
 * QUALITY_TESTS_DIR=specs/008-generation-generation-json/quality-tests pnpm tsx experiments/models/test-grok-4-fast-quality.ts
 */
