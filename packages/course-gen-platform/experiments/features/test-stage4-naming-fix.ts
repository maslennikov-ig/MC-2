 ...
 *
 * Usage:
 *   pnpm exec tsx experiments/features/test-stage4-naming-fix.ts
 *   pnpm exec tsx experiments/features/test-stage4-naming-fix.ts --direct  # Skip queue, run handler directly
 */
