...
import type { Stage6JobInput, Stage6ExecutionContext } from '../../../../stages/stage6-lesson-content/types';
...
export function buildPartialGenerateJobData({
  ...
  return {
    ...
    ragContextId: null,
    skipCompletionCheck,
    executionContext: executionContext ?? (manualTopRegeneration ? 'manual_regeneration' : 'partial_regeneration'),
