...
Remember: ABSOLUTELY NO TEXT, NO LETTERS, NO WORDS, NO TYPOGRAPHY, TEXT-FREE IMAGE.`,
  ...
  {
    stage: 'stage_7',
    promptKey: 'career_playbook_card',
    promptName: 'Career Playbook Card: Role Guide Thumbnail',
    promptDescription:
      'Generates a 1:1 square thumbnail image for Career Playbook / Role Guide library cards and viewer hero display.',
    promptTemplate: `Create a professional 1:1 square thumbnail image for a Career Playbook / Role Guide.
...
OUTPUT:
A polished square thumbnail that communicates the essence of "{{roleTitle}}" as a Role Guide while staying text-free and suitable for professional catalog browsing.`,
    variables: [
      ...
      {
        name: 'businessContextSummary',
        description: 'Short business context summary',
        required: true,
      },
      {
        name: 'roleFocusSummary',
        description: 'Role KPIs/tools/competencies summary',
        required: true,
      },
      {
        name: 'languageContext',
        description: 'Language context description (e.g., "Russian role guide content")',
        required: true,
      },
      { name: 'colorScheme', description: 'Visual style color scheme', required: true },
      { name: 'aesthetic', description: 'Visual style aesthetic', required: true },
