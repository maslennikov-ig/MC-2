...
- **Файл `StageResultsDrawer.tsx`**:
  ...
  - _Замечание:_ В задаче требовалось "Журнал", а в `ActivityLog.tsx` используется "Журнал активности". Текущий вариант "Журнал событий" — третий вариант.
  - _Решение:_ Я унифицирую это прямо сейчас на "Журнал активности", чтобы везде было одинаково.
