# Data Model: n8n-Style Graph Pipeline View
...
This document defines all TypeScript interfaces, types, and data structures for the n8n-style graph visualization feature.

---

## 1. Core Node Types

### 1.1 GraphNode (Base Interface)
...
## 10. Union Types for React Flow

```typescript
import type { Node, Edge } from '@xyflow/react';

/**
 * All custom node types union
 */
 ...
 * Custom edge type
 */
export type CustomEdgeType = Edge<GraphEdge>;
